                        ...
                        <form action="{{ route('fo.update', $fo->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name"
                                    ...
                                    value="{{ old('name', $fo->name) }}" required>
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" name="email" id="email"
                                    ...
                                    value="{{ old('email', $fo->email) }}" required>
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <a href="{{ route('fo.index') }}" class="btn btn-secondary">Batal</a>
                        </form>
                    </div>
                </div>
            </div>
